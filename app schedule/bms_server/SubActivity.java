                            ...
                            TimePickerDialog timePickerDialog1
                                ...
                                public void onTimeSet(TimePicker view, int hourOfDay1, int minute1) {
                                   /* String apm1 = "";
                                    ...
                                    mTxtTime1.setText(String.format("%d:%02d %s", hourOfDay1, minute1)); //시,분 받아서 보내줌
                                    //date1 = +hourOfDay1 +""+ minute1 + "" + "00";
                                }
...
//Get 방식
        String serverUrl = "http://15.164.218.79:8080/test_getsch/testget.jsp";
        ...
        String getUrl = serverUrl + "?title1=" + title1 + "&place1=" + place1 + "&content1=" + content1 + "&date1=" + date;
    ...
    private DatePickerDialog.OnDateSetListener dateSetListener = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear,
            ...
            if(monthOfYear+1 >= 10){
                date1=year+""+(monthOfYear+1)+""+dayOfMonth; //추가
            }
            else
                date1=year+"0"+(monthOfYear+1)+""+dayOfMonth; //추가
