...
public class SubActivity extends AppCompatActivity { //이 클래스 이름이 SubActivity
  ...
  //  private TextView ck;//추가 메시지
    ...
    private String date1; //추가
    private String date2;//추가
    private String date3;//추가
    //예현코드
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // date1=year+"년 "+month+"월 "+day+"일";
        ...
        date2 = intent.getStringExtra("next_date");//추가
...
//        ck.setText(""+ck_sub);//받아 온 데이터 tv1 에 넣기
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                date2=intent1.getStringExtra("next_date");//추가
                ...
                date3=intent1.getStringExtra("next_date2");//추가
                ...
                if(ck_sub==1)
                {
                    ...
                    //시간
                    intent.putExtra("date1",date1);//str에있는 값을 가져 가겠다//추가
                    //예현코드
                }
                else if(ck_sub==2)
                {
                    ...
                    intent.putExtra("date2",date2);//str에있는 값을 가져 가겠다 //추가
                ...
                else if(ck_sub==3)
                {
                    ...
                    intent.putExtra("date3",date3);//str에있는 값을 가져 가겠다 //추가
    ...
    private DatePickerDialog.OnDateSetListener dateSetListener = new DatePickerDialog.OnDateSetListener() {
        ...
        public void onDateSet(DatePicker view, int year, int monthOfYear,
            ...
            date1=year+"년 "+(monthOfYear+1)+"월 "+dayOfMonth+"일"; //추가
